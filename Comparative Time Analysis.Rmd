...
```{r 44, error=TRUE, fig.align='center'}
...
```{r 46, error=TRUE, fig.align='center'}
...
```{r 47, error=TRUE, fig.align='center'}
...
```{r 49d, error=TRUE, fig.align='center'}
...
```{r 49g, error=TRUE, echo=FALSE, fig.align='center'}
...
```{r 50, error=TRUE, fig.align='center'}
